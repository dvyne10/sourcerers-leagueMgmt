...
{/* This is for the past matches list for the team */}
    ...
    <ul>
      ...
      <a href='/matchdetails/1' className='general-link-no-dec'>
      ...
      <a href='/matchdetails/3' className='general-link-no-dec'>
      ...
      <li className='past-game-hover'>
      <a href='/matchdetails/2' className='general-link-no-dec'>
