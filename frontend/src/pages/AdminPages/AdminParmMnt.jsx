            ...
            <div className = "row mb-5">
                ...
                <div className="col-3">
                    { action.type === 'Creation'&& (
                        <select name="parameterId" type="text" className="form-control" onChange={handleParameterDetails}>
            ...
            { currValues.parameterId === "sport" && (
                <div>
                    <div className = "row mb-3">
                        ...
                        <div className="col-4"><input name="sportsTypeId" type="text" className="form-control" defaultValue={currValues.sportsTypeId} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        <div className="col-3 text-end"><label htmlFor="sportsName" className="form-label">Sports Name*</label></div>
                        <div className="col-4"><input name="sportsName" type="text" className="form-control" defaultValue={currValues.sportsName} onChange={handleParameterDetails} /></div>
                    </div>
                </div>
            ) }
            ...
            { currValues.parameterId === "statistic" && (
                <div>
                    ...
                    <div className = "row mb-3">
                        ...
                        <div className="col-4"><input name="statisticsId" type="text" className="form-control" defaultValue={currValues.statisticsId} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        <div className="col-3 text-end"><label htmlFor="statShortDesc" className="form-label">Statistic Short Description*</label></div>
                        <div className="col-4"><input name="statShortDesc" type="text" className="form-control" defaultValue={currValues.statShortDesc} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        <div className="col-3 text-end"><label htmlFor="statLongDesc" className="form-label">Statistic Long Description*</label></div>
                        <div className="col-4"><input name="statLongDesc" type="text" className="form-control" defaultValue={currValues.statLongDesc} onChange={handleParameterDetails} /></div>
                    </div>
                </div>
            ) }
            ...
            { currValues.parameterId === "position" && (
                <div>
                    ...
                    <div className = "row mb-3">
                        ...
                        <div className="col-4"><input name="positionId" type="text" className="form-control" defaultValue={currValues.positionId} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        <div className="col-3 text-end"><label htmlFor="positionDesc" className="form-label">Position Description*</label></div>
                        <div className="col-4"><input name="positionDesc" type="text" className="form-control" defaultValue={currValues.positionDesc} onChange={handleParameterDetails} /></div>
                    </div>
                </div>
            ) }
            ...
            { currValues.parameterId === "notification_type" && (
                <div>
                    <div className = "row mb-3">
                        ...
                        <div className="col-4"><input name="notifId" type="text" className="form-control" defaultValue={currValues.notifId} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        <div className="col-3 text-end"><label htmlFor="infoOrApproval" className="form-label" >Notification Type*</label></div>
                        <div className="col-4">
                            <select name="infoOrApproval" type="text" className="form-control" value={currValues.infoOrApproval} onChange={handleParameterDetails}>
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-9"><textarea name="message" className="form-control form-control-sm" defaultValue={currValues.message} onChange={handleParameterDetails}/></div>
                    </div>
                </div>
            ) }
            ...
            { currValues.parameterId === "login" && (
                <div>
                    <div className = "row mb-3">
                        ...
                        <div className="col-1"><input name="numberOfLoginDtlsToKeep" type="number" min="1" className="form-control" defaultValue={currValues.numberOfLoginDtlsToKeep} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        ...
                        <div className="col-1"><input name="defaultLoginTries" type="number" min="1" className="form-control" defaultValue={currValues.defaultLoginTries} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        ...
                        <div className="col-1"><input name="maxAdditionalLoginTries" type="number" min="0" className="form-control" defaultValue={currValues.maxAdditionalLoginTries} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        ...
                        <div className="col-1"><input name="lockedAccountTiming" type="number" min="1" className="form-control" defaultValue={currValues.lockedAccountTiming} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        <div className="col-6 text-end"><label htmlFor="otpExpiry" className="form-label">Number of Minutes OTP may be valid*</label></div>
                        <div className="col-1"><input name="otpExpiry" type="number" min="1" className="form-control" defaultValue={currValues.otpExpiry} onChange={handleParameterDetails} /></div>
                    </div>
                    ...
                    <div className = "row mb-3">
                        ...
                        <div className="col-1"><input name="minPasswordLength" type="number" min="1" className="form-control" defaultValue={currValues.minPasswordLength} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        ...
                        <div className="col-1"><input name="capitalLetterIsRequired" type="checkbox" className="form-check-input" defaultChecked={currValues.capitalLetterIsRequired && "checked"} onChange={handleParameterDetails} /></div>
                        <div className="col-3 text-end"><label htmlFor="capitalLettersList" className="form-label">List of Capital Letters*</label></div>
                        <div className="col-5"><input name="capitalLettersList" type="text" className="form-control" defaultValue={currValues.capitalLettersList} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        ...
                        <div className="col-1"><input name="specialCharacterIsRequired" type="checkbox" className="form-check-input" defaultChecked={currValues.specialCharacterIsRequired && "checked"} onChange={handleParameterDetails} /></div>
                        <div className="col-3 text-end"><label htmlFor="specialCharsList" className="form-label">List of Special Characters*</label></div>
                        <div className="col-5"><input name="specialCharsList" type="text" className="form-control" defaultValue={currValues.specialCharsList} onChange={handleParameterDetails} /></div>
                    </div>
                    <div className = "row mb-3">
                        <div className="col-3 text-end"><label htmlFor="numberIsRequired" className="form-label">Number is Required</label></div>
                        <div className="col-1"><input name="numberIsRequired" type="checkbox" className="form-check-input" defaultChecked={currValues.numberIsRequired && "checked"} onChange={handleParameterDetails} /></div>
                        <div className="col-3 text-end"><label htmlFor="numbersList" className="form-label">List of Numbers*</label></div>
                        <div className="col-5"><input name="numbersList" type="text" className="form-control" defaultValue={currValues.numbersList} onChange={handleParameterDetails} /></div>
                    </div>
                </div>
            ) }
            ...
            { currValues.parameterId === "dfltAnnouncement" && (
                <div>
                    <div className="row mb-3">
                        ...
                        <div className="col-9"><textarea name="defaultMsgTeamAncmt" className="form-control form-control-sm" defaultValue={currValues.defaultMsgTeamAncmt} onChange={handleParameterDetails}/></div>
                    </div>
                    <div className="row mb-3">
                        ...
                        <div className="col-9"><textarea name="defaultMsgLeagueAncmt" className="form-control form-control-sm" defaultValue={currValues.defaultMsgLeagueAncmt} onChange={handleParameterDetails}/></div>
                    </div>
                </div>
            ) }
            ...
            { currValues.parameterId === "maxParms" && (
                <div>
                    <div className="row mb-3">
                        ...
                        <div className="col-1"><input name="maxActiveLeaguesCreated" type="number" min="1" className="form-control" defaultValue={currValues.maxActiveLeaguesCreated} onChange={handleParameterDetails}/></div>
                    </div>
                    <div className="row mb-3">
                        ...
                        <div className="col-1"><input name="startLeagueApprovalExp" type="number" min="1" className="form-control" defaultValue={currValues.startLeagueApprovalExp} onChange={handleParameterDetails}/></div>
                    </div>
                    <div className="row mb-3">
                        ...
                        <div className="col-1"><input name="notifHousekeeping" type="number" min="1" className="form-control" defaultValue={currValues.notifHousekeeping} onChange={handleParameterDetails}/></div>
                    </div>
                </div>
            ) }
