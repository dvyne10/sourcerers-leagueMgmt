      ...
      <Card style={{ width: "70rem", padding: 20 }}>
        ...
        <form action="">
            ...
            <div className="row mb-2" >
                ...
                <div className="col-1"><input id="readStatus" name="readStatus" type="checkbox" className="form-check-input" defaultChecked={currValues.readStatus && "checked"} onChange={handleNotifDetails} /></div>
            </div>
            <div className = "row mb-2">
                <div className="col-3 text-end"><label htmlFor="notifType" className="form-label" >Notification Type*</label></div>
                <div className="col-7">
                    <select id="notifType" name="notifType" type="text" className="form-control" value={currValues.notifType} onChange={handleNotifType}>
            ...
            <div className = "row mb-2">
                ...
                <div className="col-2">
                    <select id="actionDone" name="actionDone" type="text" className="form-control" value={currValues.actionDone} onChange={handleNotifDetails}  disabled={currValues.disableAction}>
