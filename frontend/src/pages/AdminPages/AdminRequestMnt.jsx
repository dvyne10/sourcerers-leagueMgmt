      ...
      <Card style={{ width: "70rem", padding: 20 }}>
        ...
        <form action="">
            ...
            <div className = "row mb-2">
                ...
                <div className="col-3"><input id="requestor" name="requestor" type="text" className="form-control" defaultValue={currValues.requestor} onChange={handleRequestDetails} /></div>
            ...
            <div className = "row mb-2">
                ...
                <div className="col-4">
                    <select id="reqType" name="reqType" type="text" className="form-control" defaultValue={currValues.reqType} onChange={handleRequestDetails}>
                ...
                <div className="col-2">
                    <select id="reqStatus" name="reqStatus" type="text" className="form-control" defaultValue={currValues.reqStatus} onChange={handleRequestDetails}>
            ...
            <div className = "row mb-2">
                ...
                <div className="col-1"><input id="minAppr" name="minAppr" type="number" min="1" className="form-control" defaultValue={currValues.minAppr} onChange={handleRequestDetails} /></div>
                <div className="col-5 text-end"><label htmlFor="apprCounter" className="form-label">Approval/s Count</label></div>
                <div className="col-1"><input id="apprCounter" name="apprCounter" type="number" min="0" className="form-control" defaultValue={currValues.apprCounter} onChange={handleRequestDetails} /></div>
            </div>
            <div className = "row mb-2">
                <div className="col-3 text-end"><label htmlFor="reqExp" className="form-label">Request Expiry</label></div>
                <div className="col-4"><input id="reqExp" name="reqExp" type="text" className="form-control" defaultValue={currValues.reqExp} onChange={handleRequestDetails} /></div>
            </div>
            ...
            <div className="row mt-2">
                ...
                <div className="col-3"><input id="rcvrUsername" name="rcvrUsername" type="text" className="form-control" defaultValue={currValues.rcvrUsername} onChange={handleRequestDetails} placeholder="Search by username" /></div>
            ...
            <div className="row mt-2">
                ...
                <div className="col-3"><input id="rcvrTeamName" name="rcvrTeamName" type="text" className="form-control" defaultValue={currValues.rcvrTeamName} onChange={handleRequestDetails} placeholder="Search by team name" /></div>
            ...
            <div className="row mt-2">
                ...
                <div className="col-3"><input id="rcvrLeagueName" name="rcvrLeagueName" type="text" className="form-control" defaultValue={currValues.rcvrLeagueName} onChange={handleRequestDetails} placeholder="Search by league name" /></div>
