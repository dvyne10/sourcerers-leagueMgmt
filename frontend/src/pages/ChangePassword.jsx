...
const ChangePassword = () => {
  ...
  const validateInput = () => {
    ...
    if (input.currentPassword.trim() !== "" && input.currentPassword.trim() === input.newPassword.trim()) {
    ...
    if (input.newPassword.trim() !== "" && input.confirmNewPassword.trim() !== "" && input.newPassword.trim() !== input.confirmNewPassword.trim()) {
      ...
      <Card style={{ width: "25rem", padding: 20 }}>
        ...
        <form action="">
          <div className="mb-3">
            ...
            <input id="currentPassword" name="currentPassword" type="password"  className="form-control" value={input.currentPassword} onChange={onInputChange}/>
          </div>
          <div className="mb-3">
            <label htmlFor="newPassword" className="form-label">
              New Password*
            </label>
            <input id="newPassword" name="newPassword" type="password" className="form-control" value={input.newPassword} onChange={onInputChange}/>
          </div>
          <div className="mb-3">
            <label htmlFor="confirmNewPassword" className="form-label">
              Confirm New Password*
            </label>
            <input id="confirmNewPassword" name="confirmNewPassword" type="password" className="form-control" value={input.confirmNewPassword} onChange={onInputChange}/>
          </div>
