        ...
        <Card style={{ width: "60rem", padding: 20 }}>
          ...
          <Card.Body>
            ...
            <ul>
              ...
              <li>A much more limited set of your Personal Information -typically your name, date of birth, registration number and jersey number and position- is provided when member teams register for outside of PlayPal tournaments.
</li>
...
PlayPal maintains all player, team admin, league admin and volunteer registration files for several years as required.

You control the Personal Information you provide. When you do opt to supply Personal Information in order to take advantage of the services, that information represents the Personal Information in your personal file.
